public class BarvaRGBb {
    ...
    public BarvaRGBb(int n_r, int n_g, int n_b) throws Exception{
        if (n_r<0 || n_r >255 || n_g<0 || n_g >255 || n_b<0 || n_b >255) {
            throw new Exception("Out of color range 0 .. 255");
        }
        r = (byte)(n_r-128);
        g = (byte)(n_g-128);
        b = (byte)(n_b-128);
...
// Metody na nastavovani barvy jsou smazany, aby se barva nemohla menit
